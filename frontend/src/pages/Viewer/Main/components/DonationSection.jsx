    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="bg-white border-2 border-blue-200 rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          Support <span className="text-custom-blue">Free Education</span>
        </h2>
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <button
            onClick={() => handleCustomDonationClick()}
            className="bg-custom-blue text-white px-6 py-3 rounded-lg font-semibold hover:bg-cyan-600 transition-colors"
          >
            Donate Rs 1500
          </button>
          <button

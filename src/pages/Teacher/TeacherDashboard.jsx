...
const ActionButton = ({ icon: Icon, label, variant = "primary", onClick }) => {
  ...
  const variants = {
    primary: "bg-gray-800 hover:bg-gray-900 text-white shadow-lg",
    secondary:
      "bg-gray-900 hover:bg-gray-900 text-white shadow-lg hover:shadow-xl",
    edit: "bg-gray-800 hover:bg-gray-800 text-white text-xs px-2 py-1",
    delete: "bg-red-500 hover:bg-red-600 text-white text-xs px-2 py-1",
  };
        ...
        <div className="flex items-center justify-between p-1 mt-2">
          ...
          <div className="flex items-center gap-6 px-20">
            <div className="flex items-center gap-2">
              <User size={16} />
              <span className="text-sm">Namikaze Minato</span>
            </div>
            <div className="flex items-center gap-1 text-gray-800">
              <Star size={16} className="text-amber-500" fill="orange" />
            ...
            <button className="flex items-center gap-2 text-gray-500 hover:text-gray-600">
              <LogOut size={16} />
              <span className="text-sm hover:text-red-600">Log out</span>
            </button>
          </div>
        </div>
      </header>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent resize-none"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:ring-1 focus:border-transparent"
                >
              ...
              <button className="w-full bg-gray-800 hover:bg-gray-900 text-white py-3 rounded-md font-medium transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    ...
                    >
                      <div className="w-full flex gap-1 items-end">
                        <div
                          ...
                          style={{ height: `${donationHeight}%`, width: "30%" }}
                          title={`Donations: $${data.donations}m`}
                        />
                        <div
                          className="bg-red-500 rounded-t transition-all duration-500 hover:bg-red-600"
                          style={{
                        ...
                        />
                        <div
                          className="bg-gray-800 rounded-t transition-all duration-500 hover:bg-gray-800"
              ...
              {contentData.map((item, index) => (
                <div
                  ...
                  className={`p-3 rounded-lg ${
                    item.status === "Published" ? "bg-green-50" : "bg-yellow-50"
                  }`}
                >

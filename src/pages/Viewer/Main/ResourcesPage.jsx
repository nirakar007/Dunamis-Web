...
const VideoCard = ({ video, isExpanded, onToggle, onPlayVideo }) => (
  ...
  >
    <div className="flex items-start p-6 border rounded-md">
...
const VideoPlayer = ({ video, onClose }) => (
  <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 w-full max-w-3xl mx-auto">
    {" "}
  ...
  const videos = [
    {
      ...
      youtubeEmbedUrl: "https://www.youtube.com/embed/fgG5VqWJzO0", // Example YouTube URL
    ...
    },
    {
      ...
      youtubeEmbedUrl: "https://www.youtube.com/embed/O-M4yY7c46c", // Example YouTube URL
      type: "video",
    },
    {
      id: 3,
      ...
      youtubeEmbedUrl: "https://www.youtube.com/embed/GoXoTysy_Ew", // Example YouTube URL
      type: "video",
    },
    {
      id: 4,
        ...
        {Object.entries(tableOfContents).map(([key, section]) => (
          <div key={key}>
            <button
              ...
              className={`text-left w-full text-sm py-3 px-3 rounded-lg hover:bg-custom-blue/10 transition-colors font-medium ${
                currentChapter === key
